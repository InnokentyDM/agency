    ...
    public class AddAdController : Controller
    {
        ...
        public ActionResult Create(AddAdModel model)
        {
            ...
            {          
                ...
                //newObj.ADDRESS = "SOME_ADDRESS";
                //newObj.FLOOR = model.obj.FLOOR;
                //newObj.GeoLat = model.obj.GeoLat;
                //newObj.GeoLong = model.obj.GeoLong;
                //newObj.KIND_ID = model.obj.KIND_ID;
                //newObj.TYPE_ID = model.obj.TYPE_ID;
                //newAd.AD_TYPE_ID = model.advert.AD_TYPE_ID;
                //newAd.DESCRIPTION = model.advert.DESCRIPTION;
                //newAd.OBJECT_ID = model.advert.OBJECT_ID;
                //newAd.PRICE = model.advert.PRICE;
                //newAd.PUBLISHED = model.advert.PUBLISHED;
                //newAd.TITLE = model.advert.TITLE;
